        ...
        <div ref={ref} className=" md:mx-auto relative w-full xl:w-[75%]">
          ...
          <ul className="w-full flex flex-col items-start justify-between md:ml-4 ml-2">
            <Details
              ...
              company="OptimGov"
              companyLink="https://www.optimgov.com/"
              time="August 2023 - Current"
              address="Hay Riad, Rabat Morocco"
              work="In my current role as a Full Stack Engineer, I have the privilege of working with OptimGov to design and develop cutting-edge applications. My primary tech stack includes Spring Boot for backend development and Angular and React for creating dynamic and responsive user interfaces."
              details="Working in this role has allowed me to leverage my skills in both front-end and back-end development, enabling me to craft comprehensive and user-friendly solutions. I take pride in collaborating with cross-functional teams to bring innovative ideas to life and deliver high-quality software that meets both client and user expectations."
            />
            <Details
              ...
              work="I designed and develop an international collaboration platform for IntellCap, seamlessly integrating the features of Jira, Trello, and Slack. I implemented the login, registration, and administration functionalities while securing the backend and frontend access points."
            />
            <Details
