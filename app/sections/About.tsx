        ...
        <div className="flex flex-col items-center lg:items-start py-12 lg:flex-row lg:px-12 gap-4 md:gap-12">
          ...
          <div className="lg:w-2/4  order-1 lg:order-2">
            ...
            <p className="my-6 text-base text-center lg:text-justify font-medium">
              Hello! my name is Anas, as a senior software engineering student
              at ISMAGI in Rabat, I am passionate about developing innovative
              applications that bring value to users. With experience in both
              front-end and back-end development, I am capable of building
              full-stack applications from scratch with a focus on providing the
              best user experience possible.
            </p>
            <p className="my-6 text-base text-center lg:text-justify font-medium">
              Moving forward, my goal is to work on complex applications with
              expert teams that will help me take my skills to the next level. I
              am dedicated to delivering the best possible apps to my clients
              and users, and I am excited about the opportunities that lie
              ahead.
            </p>
          </div>
          ...
          <div className="lg:w-1/4 self-center my-8 lg:my-0 order-3 w-[75%] relative">
            <div className="flex lg:flex-col justify-center lg:justify-end items-center">
              <Link
                href={"https://www.linkedin.com/in/anassbensaid/"}
                target="_blanck"
              >
