                ...
                <Container>
                    <div className='flex items-center justify-between  md:gap-0'>
                        <button className="md:hidden flex-col justify-center items-center  sm:flex">
                            <span className={`bg-black dark:bg-light block transition-all duration-300 ease-out h-0.5 w-6 rounded-sm`}></span>
                            <span className={`bg-black dark:bg-light block transition-all duration-300 ease-out h-0.5 w-6 rounded-sm my-0.5`} ></span>
                            <span className={`bg-black dark:bg-light block transition-all duration-300 ease-out h-0.5 w-6 rounded-sm`}></span>
                        </button>
                        <Logo />
                        <Links />
