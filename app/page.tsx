...
export default function Home() {
  return (
    <main className="text-black w-full min-h-[100vh - 96px] flex items-center">
      <Container>
        <div className="flex flex-col  md:flex-row  items-center  w-full">
          <div className="md:w-1/2 order-2 md:order-1">
            ...
            <div className="flex flex-col gap-4 md:flex-row items-center md:self-start my-4">
                ...
                className="flex items-center bg-black dark:bg-light p-2.5 px-6 rounded-lg text-white dark:text-dark text-lg font-semibold hover:text-black hover:dark:text-light hover:bg-white hover:dark:bg-dark border-2 border-solid border-transparent hover:border-black hover:dark:border-light"
                >
                  Get In Touch
                </Link>
                <Link href="/dummy.pdf" className="md:ml-4 text-lg font-medium capitalize text-black dark:text-light underline"  target={"_blank"} download={true}>
                  Resume
                </Link>
            </div>
          </div>
